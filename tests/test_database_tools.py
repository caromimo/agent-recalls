...
def test_count_recalls_by_month_and_year_invalid_month():
    ...
    with pytest.raises(ValueError, match="Invalid month name provided."):
        count_recalls_by_month_and_year(2022, "smarch")
